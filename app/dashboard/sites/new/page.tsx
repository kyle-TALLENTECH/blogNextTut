...
// import { siteSchema } from "@/app/utils/zodSchemas"; // Import siteSchema
                ...
                <CardContent>
                    <div className="flex flex-col gap-y-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Textarea name={fields.description.name} key={fields.description.key} defaultValue={fields.description.initialValue} placeholder="Description" />
