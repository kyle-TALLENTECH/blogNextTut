...
const TailwindEditor = ({ onChange, initialValue }: EditorProps) => {
    ...
    return (
        <EditorRoot>
            ...
            >
                <EditorCommand className='z-50 h-auto max-h-[330px]  w-72 overflow-y-autodddddd rounded-md border border-muted bg-background px-1 py-2 shadow-md transition-all'>
